...
class PlanEditForm extends FormBase {
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $planId = NULL) {
    /** @var BillingAgreement $pba */
    $pba = Drupal::service('paypal.billing.agreement');
    $plan = $pba->getPlan($planId);
    ...
    $form['#title'] = $this->t('Plan edit "' . $plan->getName() . '" (' . $planId . ')');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    // @todo salvar el plan modificado.
  }
