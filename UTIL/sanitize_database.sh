...
# Default sanitization for users table in database.
echo
echo -e "${LBLUE} > Sanitizing core fields.${DEFAULT}"
drush sqlsan -y --sanitize-password=password --sanitize-email=user%uid@localhost.com
...
echo -e "${LBLUE} > Table field_data_field_nombre.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_name.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_apellidos.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_email.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_pagina_web.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_perfil_facebook.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_perfil_twitter.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_perfil_linkedin.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_perfil_google_plus.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_perfil_en_drupal_org.${DEFAULT}"
...
echo -e "${LBLUE} > Table field_data_field_mensaje.${DEFAULT}"
